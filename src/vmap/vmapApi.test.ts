import { VmapManifestAsset } from './vmapApi';
    ...
    describe('replaceMediaFiles', () => {
        ...
        <vmap:VMAP xmlns:vmap="http://www.iab.net/vmap-1.0" version="1.0">
          <vmap:AdBreak timeOffset="start" breakType="linear">
            ...
            const assets: VmapManifestAsset[] = [
                {
                    creativeId: 'ad123',
        ...
        <vmap:VMAP xmlns:vmap="http://www.iab.net/vmap-1.0" version="1.0">
          <vmap:AdBreak timeOffset="start" breakType="linear">
            ...
            const result = replaceMediaFiles(vmapXml, assets);
            const mediaTypeCount = (result.match(/application\/x-mpegURL/g) || []).length;
...
`;
            ...
            const result = replaceMediaFiles(vmapXml, assets);
            expect(result).toContain('<vast:VAST xmlns:vast="http://www.iab.net/VAST" version="4.0"></vast:VAST>');
